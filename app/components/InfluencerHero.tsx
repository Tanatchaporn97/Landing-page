...
export default function InfluencerHero({ lang = "th" }: { lang?: "th" | "en" }) {
  ...
  return (
    <section className="hero-section-inf" style={{ padding: "120px 64px 80px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, #FFFFFF 0%, #F7F2E9 100%)" }}>
