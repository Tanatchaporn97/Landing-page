...
export default function SuccessStoriesSlider({ lang = "th" }: { lang?: "th" | "en" }) {
  ...
  const stories = lang === "th" ? [
    ...
    { href: `/${lang}/success/watsons`,        img: "/success-stories-2/Success stories-10.jpg", cat: "HEALTH & BEAUTY",  title: "Watsons — DAP Double Booster", tagline: "ทำงานเร็ว ทันแคมเปญ ด้วย KOL และ KOC",               stats: [{ val: "141,200", label: "Reach" }, { val: "8.5K",  label: "Engagement" }, { val: "6.03%", label: "Eng. Rate" }] },
    ...
    { href: `/${lang}/success/watsons`,        img: "/success-stories-2/Success stories-10.jpg", cat: "HEALTH & BEAUTY",  title: "Watsons — DAP Double Booster", tagline: "Fast-turnaround KOL & KOC Campaign",               stats: [{ val: "141,200", label: "Reach" }, { val: "8.5K",  label: "Engagement" }, { val: "6.03%", label: "Eng. Rate" }] },
